...
if (isset($_POST['search-date'])) {
    ...
    if (empty($_POST['search-date-box'])) {
        ...
        if(!preg_match('^\d{4}\-(0[1-9]|1[012])\-(0[1-9]|[12][0-9]|3[01])$^', $result)) {
            ...
            $sql .= "WHERE Invoice_Creation_Date = '{$result}'";
        }
    }
}
...
<html lang="en">
  ...
  <body>
    ...
    <form name="search-form" method="POST" action="invoice.php">
    ...
    <form name="search-date-form" method="POST" action="invoice.php">
    ...
    <table width="80%" cellpadding="8" cellspace="7">
        ...
        <tr>
            ...
            <td><?php echo $row['Invoice_Creation_Date']; ?></td>
